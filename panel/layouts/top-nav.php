<header class="navbar navbar-expand-lg sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="<?= url('panel') ?>">trv::blog Dashboard</a>
...
<!--nav class="navbar navbar-expand-lg bg-dark border-bottom border-bottom-dark sticky-top" data-bs-theme="dark">
    ...
    <a class="navbar-brand" href="<?= url('index.php') ?>">trv::blog Panel</a>
